        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          <div>
            ...
            <p className='mt-4 text-sm text-slate-600 dark:text-slate-400 leading-relaxed'>
              一个现代化的博客平台，分享技术文章、生活感悟和创作内容。用 Next.js 构建，追求极致的阅读体验。
            </p>
          </div>
          ...
          <div>
            ...
            <div className='mt-4 flex gap-4'>
              <a
                ...
                className='p-2 text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-all'
              >
