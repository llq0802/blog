  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        h2: ({ children }) => (
          <h2 className='text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4'>{children}</h2>
        ),
        h3: ({ children }) => (
          <h3 className='text-xl font-bold text-slate-900 dark:text-white mt-8 mb-3'>{children}</h3>
        ),
        p: ({ children }) => <p className='text-slate-700 dark:text-slate-300 leading-relaxed mb-6'>{children}</p>,
        a: ({ href, children }) => (
          <a
            href={href}
        ...
        ul: ({ children }) => (
          <ul className='list-disc list-inside space-y-2 mb-6 text-slate-700 dark:text-slate-300'>{children}</ul>
        ),
        ol: ({ children }) => (
          <ol className='list-decimal list-inside space-y-2 mb-6 text-slate-700 dark:text-slate-300'>{children}</ol>
        ),
        ...
        img: ({ src, alt }) => (
          <div className='rounded-xl my-8 w-full'>
            <Image
              src={src as string}
              alt={alt as string}
              width={800}
        ...
        table: ({ children }) => (
          <div className='overflow-x-auto my-6'>
            <table className='w-full border-collapse border border-slate-200 dark:border-slate-700'>{children}</table>
          </div>
        ),
